# Generated by Powerlevel10k configuration wizard on 2020-04-26 at 22:53 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 57930.
# Wizard options: nerdfont-complete + powerline, large icons, unicode, lean, 24h time,
# 2 lines, disconnected, sparse, many icons, fluent, transient_prompt,
# instant_prompt=off.
